...
class OpeningEntryDialogForm extends StatelessWidget {
  final bool isUpdate, isReceipt;
  const OpeningEntryDialogForm({
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: GetBuilder<OpeningEntryController>(
          autoRemove: false,
          builder: (controller) {
            return Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    dialogButtonWidget(
                      ...
                      () async {
                        isUpdate
                            ? controller.updateOpeningEntryDatas()
                            : controller.addOpeningEntryDatas();

...
Widget valuationSearchFields(
  ...
  return Column(
    ...
    children: [
      ...
      verticalGap(5),
      SortDropdown(
        selectedValue: controller.valuationSortField,
        items: controller.valuationSortFields,
        onChanged: controller.changeValuationSortField,
        contentColor: white,

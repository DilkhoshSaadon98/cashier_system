...
class AccountStatementTable extends StatelessWidget {
  ...
  const AccountStatementTable({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    return TableWidget(
      ...
      rows: List.generate(controller.accountStatementData.length, (index) {
        final record = controller.accountStatementData[index];
        return [
          Padding(

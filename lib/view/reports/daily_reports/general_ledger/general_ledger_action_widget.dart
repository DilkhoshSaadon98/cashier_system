...
class GeneralLedgerActionWidget extends StatelessWidget {
  final DailyReportsController controller;
  const GeneralLedgerActionWidget({super.key, required this.controller});
    ...
    return Column(
      ...
      children: [
        SortDropdown(
          ...
          items: controller.sortGeneralLedgerFields,

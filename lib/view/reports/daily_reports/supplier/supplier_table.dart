...
class SupplierTable extends StatelessWidget {
  ...
  const SupplierTable({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    return TableWidget(
      ...
      flexes: const [1, 1, 2, 1, 2, 2, 2, 2, 2],
      rows: List.generate(controller.supplierData.length, (index) {
        final record = controller.supplierData[index];
        return [
          Padding(

import 'package:cashier_system/controller/home/add_admin_controller.dart';
          ...
          child: ScreenBuilder(
            windows: Row(
              children: [
                Expanded(
                  child: Scaffold(
                    appBar: customAppBarTitle("Add Admin", true),
                    backgroundColor: white,
                    body: Container(
                      ...
                      width: Get.width / 2,
                      child:
                          GetBuilder<AddAdminController>(builder: (controller) {
                        return Form(
                          key: controller.key,
                          child: ListView.builder(
                              shrinkWrap: true,
                              itemCount:
                                  controller.accountListTitles.length + 1,
            ...
            mobile: Scaffold(
              ...
              body: Container(
                alignment: Alignment.topCenter,
                padding: const EdgeInsets.all(15),
                child: GetBuilder<AddAdminController>(builder: (controller) {
                  return Form(
                    key: controller.key,
                    child: ListView.builder(

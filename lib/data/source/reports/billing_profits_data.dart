...
class BillingProfitsData {
  SqlDb db = SqlDb();
  String viewInvoiceSummary = 'view_sales_invoices_summary';
  ...
  Future<Map<String, dynamic>> getInventorySummaryData({
    ...
    // Final SQL query
    String sql =
        "SELECT * FROM $viewInvoiceSummary WHERE $whereClause ORDER BY $sortBy ${ascSort! ? 'ASC' : "DESC"} LIMIT $limit OFFSET $offset";

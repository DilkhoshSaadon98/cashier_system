...
//! Consatnt Image :
  ...
  static const String discountingCart = "$server/cashier/cashier_buttons/discounting_items.php";
  ...
  static const String cartOwnerName = "$server/cashier/cashier_buttons/cart_owner_name.php";
